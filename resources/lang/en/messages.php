...
return [
    ...
    "device_vote_error"=> "You have already voted with this device",
    "ip_vote_error"=> "You have already voted with this IP",
    "fingerprint_vote_error"=> "You have already voted with this fingerprint",
